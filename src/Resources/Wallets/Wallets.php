 ...
 * Wallets resource
 *
 * Manages both offramp wallets and blockchain wallets
 */
class Wallets
{
    public function __construct(
     ...
     */
    public function listOfframpWallets(ListOfframpWalletsInput $input): BlindPayApiResponse
    {
     ...
     */
    public function createOfframpWallet(CreateOfframpWalletInput $input): BlindPayApiResponse
    {
     ...
     * @return BlindPayApiResponse<OfframpWallet>
     */
    public function getOfframpWallet(GetOfframpWalletInput $input): BlindPayApiResponse
    {
        if (empty($input->id)) {
     ...
     */
    public function listBlockchainWallets(string $receiverId): BlindPayApiResponse
    {
        if (empty($receiverId)) {
            return BlindPayApiResponse::error(
     ...
     * @return BlindPayApiResponse<BlockchainWallet>
     */
    public function createBlockchainWalletWithAddress(CreateBlockchainWalletWithAddressInput $input): BlindPayApiResponse
    {
        $response = $this->client->post(
     ...
     * @return BlindPayApiResponse<BlockchainWallet>
     */
    public function createBlockchainWalletWithHash(CreateBlockchainWalletWithHashInput $input): BlindPayApiResponse
    {
        $response = $this->client->post(
            "/instances/{$this->instanceId}/receivers/{$input->receiverId}/blockchain-wallets",
            $input->toArray()
     ...
     */
    public function getBlockchainWalletMessage(string $receiverId): BlindPayApiResponse
    {
        if (empty($receiverId)) {
            return BlindPayApiResponse::error(
                new \BlindPay\SDK\Types\ErrorResponse('Receiver ID cannot be empty')
     ...
     * @return BlindPayApiResponse<BlockchainWallet>
     */
    public function getBlockchainWallet(GetBlockchainWalletInput $input): BlindPayApiResponse
    {
        if (empty($input->id)) {
            return BlindPayApiResponse::error(
     ...
     */
    public function deleteBlockchainWallet(DeleteBlockchainWalletInput $input): BlindPayApiResponse
    {
        if (empty($input->id)) {
            return BlindPayApiResponse::error(
                new \BlindPay\SDK\Types\ErrorResponse('Blockchain wallet ID cannot be empty')
