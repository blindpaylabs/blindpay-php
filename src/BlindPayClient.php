...
use BlindPay\SDK\Resources\AvailableResource;
...
class BlindPayClient implements ApiClientInterface
{
    ...
    public readonly AvailableResource $available;
    ...
    public function __construct(
        ...
        $this->available = new AvailableResource($this);
    }
